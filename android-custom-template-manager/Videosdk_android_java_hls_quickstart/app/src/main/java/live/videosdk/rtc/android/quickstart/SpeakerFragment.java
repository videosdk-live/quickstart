...
public class SpeakerFragment extends Fragment {
    ...
    private void showSettingDialog() {
        ...
        btnBgColor.setOnClickListener(v -> {
            ...
            meeting.pubSub.publish("CHANGE_BACKGROUND", et_bgColor.getEditText().getText().toString().trim(), publishOptions);
            dialog.dismiss();
            Toast.makeText(mContext, "LiveStream Background Changed", Toast.LENGTH_SHORT).show();
        });
        ...
        btnNotify.setOnClickListener(v1 -> {
            ...
            // Sending the Message using the publish method
            meeting.pubSub.publish("VIEWER_MESSAGE", et_message.getEditText().getText().toString().trim(), publishOptions);
    ...
    private void setActionListeners() {
        ...
        btnHls.setOnClickListener(v -> {
            if (!hlsEnabled) {
                ...
                final String templateUrl = "https://lab.videosdk.live/react-custom-template-demo?meetingId=" + meeting.getMeetingId() + "&token=" + token;
