# Video SDK for Flutter (Android and iOS) - Riverpod Quickstart
...
cd quickstart/flutter-rtc/quickstart_riverpod
```
...
### 4. Generate Riverpod `.g.dart` Files
